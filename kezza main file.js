...
1. Jaipur: Maps → https://maps.app.goo.gl/4eUGixic35V777yd8
2. Sikar: Maps → https://maps.app.goo.gl/kFkEyXNvTP6DSGKq6
...
const SPECIALIST_DATABASE = {
    ...
    HAIR_TRANSPLANT_SIKAR: {
        ...
        services: ['Hair Transplant', 'Facial Aesthetics'],
        location: 'Sikar',
        contact: '8130888129'
    },
    WEIGHT_LOSS: {
    ...
    ENT_RHINOPLASTY: {
        department: 'ENT & Rhinoplasty Department',
        specialists: ['Dr. Mandhata Sharma'],
        specialistName: 'Dr. Mandhata Sharma (MS ENT - MAMC, Gold Medalist)',
        contact: '9284517427',
        location: 'Jaipur'
    }
};
...
- PMU -> PMU / Microblading Consultation (Dr. Krishna Choudhary, Jaipur & Sikar, 9079161300)
- SMP -> SMP Scalp Density Consultation (Dr. Krishna Choudhary, Jaipur & Sikar, 9079161300)
...
function getDeterministicDepartmentAndSpecialist(category, clinic, treatment) {
    ...
    // Rhinoplasty / ENT
    if (cat.includes('RHINOPLASTY') || cat.includes('ENT') || tr.includes('rhinoplasty') || tr.includes('nose') || tr.includes('ent') || tr.includes('septum')) {
        return {
            departmentKey: 'ENT_RHINOPLASTY',
            department: 'ENT & Rhinoplasty',
            specialist: 'Dr. Mandhata Sharma',
            whatsappNumber: '919284517427'
        };
    }
