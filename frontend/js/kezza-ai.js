...
(function () {
    ...
    // ============================================
    // VERIFIED KEZZA CLINIC LOCATIONS & GOOGLE MAPS (Jaipur, Sikar & Ajmer)
    // ============================================
    const CLINIC_LOCATIONS = {
        ...
        ajmer: {
            ...
            mapsBtnText: '📍 Open Ajmer Clinic in Google Maps',
            flagship: false
        }
    };
    ...
    const DEPARTMENTS = {
        ...
        internal_medicine: {
            ...
            name: 'General & Internal Medicine (Dr. Youvraj Singh)',
            phone: '9284517427',
            consultationBtn: '📅 Consult Dr. Youvraj Singh',
            buttonTextEn: 'Chat with Dr. Youvraj Singh',
            buttonTextHi: 'Dr. Youvraj Singh se Chat Karein',
            defaultMsg: 'Hello Kezza Team, I would like to consult with Dr. Youvraj Singh for Internal Medicine / Health Management.',
            scope: ['internal medicine', 'general medicine', 'physician', 'doctor youvraj', 'dr youvraj', 'dr. youvraj', 'youvraj singh', 'general health', 'chronic condition', 'medical consultation', 'health checkup', 'general physician']
        }
    };
    ...
    const SPECIALISTS = {
        ...
        dr_mandhata: {
            ...
            role: 'Visiting Consultant – ENT & Rhinoplasty Surgeon',
            phone: '9284517427',
        ...
        dr_aliza: {
            id: 'AJMER_SPECIALIST',
            name: 'Dr. Aliza Rizvi',
            role: 'Oral & Maxillofacial, Aesthetic & Hair Transplant Surgeon',
            location: 'Ajmer',
            phone: '9216088257',
            buttonTextEn: 'Chat with Dr. Aliza Rizvi (Ajmer)',
            buttonTextHi: 'Dr. Aliza Rizvi se Chat Karein (Ajmer)',
            defaultMsg: 'Hello Dr. Aliza Rizvi Team, I would like to book a consultation at Kezza Clinic Ajmer.'
        },
        dr_nakul: {
            id: 'PLASTIC_SURGERY',
            name: 'Dr. Nakul Somani',
            role: 'Visiting Consultant – Aesthetic & Reconstructive Plastic Surgeon',
            location: 'Jaipur',
            phone: '9284517427',
            buttonTextEn: 'Chat with Dr. Nakul Somani (Jaipur)',
            buttonTextHi: 'Dr. Nakul Somani se Chat Karein (Jaipur)',
            defaultMsg: 'Hello Kezza Team, I would like to consult with Dr. Nakul Somani for Aesthetic & Plastic Surgery.'
        },
        dr_youvraj: {
            id: 'INTERNAL_MEDICINE',
            name: 'Dr. Youvraj Singh',
            role: 'Visiting Consultant – Physician & Internal Medicine Specialist',
            location: 'Jaipur',
            phone: '9284517427',
            buttonTextEn: 'Chat with Dr. Youvraj Singh (Jaipur)',
            buttonTextHi: 'Dr. Youvraj Singh se Chat Karein (Jaipur)',
            defaultMsg: 'Hello Kezza Team, I would like to consult with Dr. Youvraj Singh for Internal Medicine / General Healthcare.'
        }
    };
    ...
    const DOCTORS = [
        ...
        },
        {
            ...
            title: 'Oral & Maxillofacial, Aesthetic & Hair Transplant Surgeon',
            specialization: 'Oral and Maxillofacial Surgeon with expertise in hair transplantation and facial aesthetics',
            brief: 'Specialist Oral and Maxillofacial Surgeon devoted to hair transplantation and facial aesthetics. Leading our Ajmer centre.',
            location: 'Ajmer'
        },
        {
            name: 'Krishna',
        ...
        {
            name: 'Dr. Mandhata Sharma',
            title: 'Visiting Consultant – ENT, Rhinoplasty and Head & Neck Surgeon',
        ...
        {
            name: 'Dr. Nakul Somani',
            title: 'Visiting Consultant – Aesthetic & Reconstructive Plastic Surgeon',
            specialization: 'Plastic and reconstructive surgery, body contouring, high-definition liposuction, breast and facial aesthetic surgeries, non-surgical procedures',
            brief: 'Trained at Sir Ganga Ram Hospital, Delhi with fellowship at Cocoona Centre of Aesthetic Excellence, Dubai under Dr. Sanjay Parashar.',
            location: 'Jaipur'
        },
        {
            name: 'Dr. Youvraj Singh',
            title: 'Visiting Consultant – Physician & Internal Medicine Specialist',
            specialization: 'Internal Medicine, General Medicine, diagnosis and comprehensive management of acute and chronic medical conditions',
            brief: 'MBBS, MD (Medicine). Dedicated physician focusing on compassionate care, accurate diagnosis, evidence-based treatment, and personalized health management.',
            location: 'Jaipur'
        }
    ];
...
`;
    ...
    function updateBusinessHoursHeaderStatus() {
        ...
        if (!statusEl) return;
        statusEl.innerHTML = `<span class="kezza-status-dot online"></span> <span>Online</span>`;
...
— Kezza AI`;
    ...
    function validateClinicLocation(text) {
        ...
        if (lower.includes('ajmer')) {
            return { valid: true, value: 'Ajmer' };
        }
        return null;
    }
                ...
                if (isHT) {
                    return {
                        text: (currentLang === 'hinglish' || currentLang === 'hindi')
                            ? `Hair Transplant consultation ke liye Kezza team <strong>Sikar</strong>, <strong>Jaipur</strong> aur <strong>Ajmer</strong> mein available hai. Aap kis Kezza clinic mein consultation lena chahenge?`
                            : `For Hair Transplant, Kezza specialist doctors are available across <strong>Sikar</strong>, <strong>Jaipur</strong> and <strong>Ajmer</strong>. Which Kezza clinic location would you prefer?`,
                        quickReplies: ['📍 Sikar Clinic (Elite Surgical)', '📍 Jaipur Clinic', '📍 Ajmer Clinic']
                    };
                }
                return {
                    text: (currentLang === 'hinglish')
                    ...
                    quickReplies: ['📍 Jaipur Clinic', '📍 Sikar Clinic', '📍 Ajmer Clinic']
                };
            }
    ...
    function resolveBookingParams(userText, norm, stateRef) {
        ...
        if (lower.includes('ajmer')) clinic = 'Ajmer';
            ...
            case CONSULTATION_STATES.CLINIC_LOCATION: {
                ...
                if (!clinicRes || !clinicRes.valid) {
                    if (clinicRes && clinicRes.error === 'ALWAR_NOT_OFFERED') {
                        return {
                            text: (currentLang === 'hinglish')
                                ? `Kezza ke clinics currently <strong>Jaipur</strong>, <strong>Sikar</strong> aur <strong>Ajmer</strong> mein available hain (Alwar location available nahi hai). Kripya Jaipur, Sikar ya Ajmer clinic select karein:`
                                : `Kezza currently operates clinics in <strong>Jaipur</strong>, <strong>Sikar</strong> and <strong>Ajmer</strong>. Please select Jaipur, Sikar or Ajmer clinic:`,
                            quickReplies: ['📍 Jaipur Clinic', '📍 Sikar Clinic', '📍 Ajmer Clinic']
                        };
                    }
                    return {
                        text: (currentLang === 'hinglish')
                            ? `Please Jaipur, Sikar ya Ajmer clinic select karein:`
                            : ((currentLang === 'hindi') ? `कृपया Jaipur, Sikar या Ajmer क्लीनिक चुनें:` : `Please select Jaipur, Sikar or Ajmer clinic:`),
                        quickReplies: ['📍 Jaipur Clinic', '📍 Sikar Clinic', '📍 Ajmer Clinic']
                    };
                }
                flow.data.selectedClinic = clinicRes.value;
    ...
    async function submitConsultationAuto(data, lang) {
        ...
        const payload = {
            ...
            Duration: data.duration || '',
            'Concern / Duration': data.duration || detailTitle || 'Consultation',
            'concern / duration': data.duration || detailTitle || 'Consultation',
            'Concern/Duration': data.duration || detailTitle || 'Consultation',
            concernDuration: data.duration || detailTitle || 'Consultation',
            date: data.date || '',
            ...
            department: routing.departmentName || routing.departmentKey || 'General',
            Department: routing.departmentName || routing.departmentKey || 'General',
            'Department': routing.departmentName || routing.departmentKey || 'General',
        ...
        // Deduplicated safe sync:
        // Try /api/lead first. If backend is running, it saves to DB & syncs to Google Sheets (no duplicate).
        ...
        if (!timeInfo.isOpen) {
            afterHoursNote = (lang === 'hinglish')
                ? `<p style="font-size:12px;color:#0096a6;margin:6px 0;"><em>⏰ Note: Hamari consultation team abhi currently closed hai. Request record ho gaya hai aur team subah 9:00 AM se contact karegi.</em></p>`
    ...
    function renderBranchDetails(branch, lang) {
        if (branch === 'jaipur') {
            return {
                ...
                quickReplies: ['📅 Book at Jaipur', '📍 Sikar Clinic', '📍 Ajmer Clinic', '💇 View Treatments']
            };
        }
        if (branch === 'ajmer') {
            return {
                text: (lang === 'hinglish')
                    ? `📍 <strong>Kezza Ajmer Clinic:</strong><br>First Floor, Shastri Nagar, Oasis Complex and Hotels, Jawahar Nagar, Ajmer, Rajasthan 305001.<br>👨‍⚕️ <strong>Specialists:</strong> Dr. Dhiral Vijayvargiya & Dr. Aliza Rizvi<br>📞 <strong>Phone/WhatsApp:</strong> +91-9216088257<br>📧 <strong>Email:</strong> kezzaclinic@gmail.com<br>⏰ Timings: 9:00 AM – 8:00 PM (All 7 Days)<br><br><a href="https://maps.app.goo.gl/zMajvKmT5N7coswJA?g_st=ic" target="_blank" class="kezza-map-btn"><i class="fas fa-map-marker-alt"></i> View Ajmer Clinic on Google Maps</a>`
                    : `📍 <strong>Kezza Ajmer Clinic:</strong><br>First Floor, Shastri Nagar, Oasis Complex and Hotels, Jawahar Nagar, Ajmer, Rajasthan 305001.<br>👨‍⚕️ <strong>Specialists:</strong> Dr. Dhiral Vijayvargiya & Dr. Aliza Rizvi<br>📞 <strong>Phone/WhatsApp:</strong> +91-9216088257<br>📧 <strong>Email:</strong> kezzaclinic@gmail.com<br>⏰ Timings: 9:00 AM – 8:00 PM (Monday to Sunday)<br><br><a href="https://maps.app.goo.gl/zMajvKmT5N7coswJA?g_st=ic" target="_blank" class="kezza-map-btn"><i class="fas fa-map-marker-alt"></i> View Ajmer Clinic on Google Maps</a>`,
                quickReplies: ['📅 Book at Ajmer', '📍 Jaipur Clinic', '📍 Sikar Clinic', '💇 View Treatments']
            };
        }
        return {
            text: (lang === 'hinglish')
            ...
            quickReplies: ['📅 Book at Sikar', '📍 Jaipur Clinic', '📍 Ajmer Clinic', '💇 View Treatments']
        };
    }
...
<div class="kezza-photo-card">
    ...
    async function generateLocalResponse(userText) {
        ...
        // 4. Branch Queries (Jaipur, Sikar & Ajmer)
        ...
        if (lower === '📍 ajmer' || lower === 'ajmer' || lower === 'ajmer clinic' || lower === 'view ajmer location' || ((lower.includes('ajmer') || lower.includes('shastri nagar') || lower.includes('jawahar nagar')) && (lower.includes('clinic') || lower.includes('location') || lower.includes('address') || lower.includes('kahan') || lower.includes('where')))) {
            return renderBranchDetails('ajmer', lang);
        }

        // Alwar specifically asked -> Clarify Kezza operates in Jaipur, Sikar & Ajmer
        if (norm.includes('alwar')) {
            return {
                text: (lang === 'hinglish' || lang === 'hindi')
                    ? `Kezza ke clinics currently <strong>Jaipur</strong>, <strong>Sikar</strong> aur <strong>Ajmer</strong> mein hain (Alwar location available nahi hai). Aap Jaipur, Sikar ya Ajmer clinic mein consultation book kar sakte hain!`
                    : `Kezza currently operates clinics in <strong>Jaipur</strong>, <strong>Sikar</strong> and <strong>Ajmer</strong> (we do not have an Alwar branch). We would be delighted to welcome you at Jaipur, Sikar or Ajmer!`,
                quickReplies: ['📍 Jaipur', '📍 Sikar', '📍 Ajmer', '📅 Book Consultation']
            };
        }
    ...
    function createChatWidget() {
        ...
        fab.id = 'kezzaChatFab';
        fab.setAttribute('aria-label', 'Open Kezza Assistant');
        fab.innerHTML = `
        ...
        win.setAttribute('aria-label', 'Kezza Chat Assistant Window');
        win.setAttribute('aria-hidden', 'true'); // FIX U7: hidden until opened
        win.innerHTML = `
            <div class="kezza-chat-header">
                <div class="kezza-chat-avatar" title="Kezza Clinic AI Assistant">
                    <img src="/images/logo.png" alt="Kezza Clinic" class="kezza-avatar-logo-main">
                </div>
                <div class="kezza-chat-header-info">
                    <div class="kezza-chat-header-title">Kezza</div>
                ...
                <div class="kezza-chat-header-actions">
                    ...
                    <button class="kezza-chat-minimize" id="kezzaChatMinimize" aria-label="Close Kezza chat window" title="Close">✕</button>
                </div>
            </div>

            <div class="kezza-chat-3d-bg" aria-hidden="true">
                <img src="/images/logo.png" alt="" width="297" height="200" loading="lazy">
            </div>
        ...
        tooltip.innerHTML = `
            👋 Ask Kezza! Need clinic info or consultation?
        ...
        // ── 3D Rotating Logo in Chat Background ──
        const chatMsgBox = document.getElementById('kezzaMessages');
        const chat3dLogo = win.querySelector('.kezza-chat-3d-bg img');
        if (chatMsgBox && chat3dLogo) {
            let tickingChat = false;
            function updateChat3d() {
                const y = chatMsgBox.scrollTop + (window.pageYOffset || 0) * 0.3;
                const ry = (y * 0.26);
                const rx = Math.sin(y / 200) * 12;
                const rz = (y * 0.05);
                chat3dLogo.style.transform = `rotateY(${ry}deg) rotateX(${rx}deg) rotateZ(${rz}deg)`;
                tickingChat = false;
            }
            chatMsgBox.addEventListener('scroll', () => {
                if (!tickingChat) {
                    requestAnimationFrame(updateChat3d);
                    tickingChat = true;
                }
            }, { passive: true });
            window.addEventListener('scroll', () => {
                if (!tickingChat && state.isOpen) {
                    requestAnimationFrame(updateChat3d);
                    tickingChat = true;
                }
            }, { passive: true });
    ...
    function addBotMessage(html, quickReplies) {
        ...
        msg.innerHTML = `
            <div class="kezza-msg-avatar">
                <img src="/images/logo.png" alt="Kezza Clinic" class="kezza-msg-logo-img">
            </div>
